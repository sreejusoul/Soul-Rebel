...
module.exports = {
    ...
    SESSION: process.env.ABUSER_CODE === undefined ? '' : process.env.ABUSER_CODE,
    ...
    OWNER: process.env.OWNER_NAME === undefined ? '💖ABU💖' : process.env.OWNER_NAME,
    ...
    ALL: process.env.ALL_CAPTION === undefined ? 'Made By Abuser' : process.env.ALL_CAPTION,
    ...
    LOGO_NAME: process.env.LOGO_NAME === undefined ? 'Abu_ser' : process.env.LOGO_NAME,
    ...
    BOT: process.env.BOT_NAME === undefined ? '⊢‒‒‒ ⋈ Abu ser ⋈ ‒‒‒⊣' : process.env.BOT_NAME,
    ...
    ALLEMOJI: process.env.CMD_LIST === undefined ? 'Abu🎗️/💝/✨/📝' : process.env.CMD_LIST,
