...
module.exports = {
    ...
    SESSION: process.env.REBEL_CODE === undefined ? '' : process.env.REBEL_CODE,
    ...
    OWNER: process.env.OWNER_NAME === undefined ? '💖Soul-Rebel💖' : process.env.OWNER_NAME,
    PHONE: process.env.NUMBER === undefined ? '+917025994178' : process.env.NUMBER,   
    OA_NAME: process.env.DEPLOYER === undefined ? 'Soul-Rebel' : process.env.DEPLOYER,
    ALL: process.env.ALL_CAPTION === undefined ? 'Made By Soul-Rebel' : process.env.ALL_CAPTION,
    ...
    LOGO_NAME: process.env.LOGO_NAME === undefined ? 'Soul-Rebel' : process.env.LOGO_NAME,
    ...
    BOT: process.env.BOT_NAME === undefined ? '⊢‒‒‒ ⋈ Soul-Rebel ⋈ ‒‒‒⊣' : process.env.BOT_NAME,
    BOTSK: process.env.BOT_NAME === undefined ? 'Abuser' : process.env.BOT_NAME,
    ...
    ALLEMOJI: process.env.CMD_LIST === undefined ? 'Soul-Rebel🎗️/💝/✨/📝' : process.env.CMD_LIST,
