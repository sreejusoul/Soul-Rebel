...
r_text[1] = "Aʙᴜ SERINE tholpikkaan ningalkavilla. Jeevitathil Aʙᴜ SERINE tholpichittundu… palarum… palavattom…😥😥 aarellum aaa sed bgm onn iduo...";
r_text[2] = "Aʙᴜ SER says i love you 😘";
r_text[3] = "Heleneyude yudhangal Company Kanan Povunnatheyuloo";
r_text[4] = "hi, how are you";
r_text[5] = "ennikk korch rest theroo...🥵🥵";
r_text[6] = "Aʙᴜ SER - Bot - Miss Aʙᴜ SER\ningane ethra ethra paerugal aan alle enikk..😂🤣";
...
r_text[8] = "\n enne vilicho...?🧐 \n";
r_text[9] = "ente per Aʙᴜ SER ,ninte per donkey, backi ellarum monkey😼😼";
r_text[10] = "nee vilicha enikk villi kelkathe irrikkaan pattuo";
r_text[11] = "do you know who is my creator..? its none other than Aʙᴜ SER";
...
r_text[13] = ".song adich thangalude fav song name para bhaagyandel Aʙᴜ SER ath download aakki therum";
...
r_text[18] = "enikk njan und Aʙᴜ SER uyir";
...
r_text[21] = "Kochi pazhaya kochiyellennariyam… pakshe Aʙᴜ SER pazhaya Aʙᴜ SER thanneya...😎\n\n";
r_text[22] = "Kaanaan oru look illanney ullu… bhayankara budhiya\n\n ninnak allatto enik Miss Aʙᴜ SERkk";
r_text[23] = "Ithalla ithinapparam chaadi kadannavananee Miss Aʙᴜ SER😆";
